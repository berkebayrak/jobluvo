...
**Superseded on 18 September 2026 by D-034, and this paragraph still described it as current until 19 September.** It read: "It catches 28 of 28 and passes 26 of 26, asserted on every run of `npm test`. That result is not wrong and is not withdrawn." The first half stopped being true when the meaning comparison was removed. The file asserts 18 of 18 supported lines pass; it asserts nothing about the second author's 14 and nothing about the 4 pending, on purpose, under a header saying it is not evidence that fabrication is caught. **On the 32 unsupported lines it asserts one thing, and this page used to say it asserted none** (corrected 19 September 2026, the ninth review's item 6): `STILL_CAUGHT` names **8 of the 32 by their text**, and the test fails if any of those 8 comes back `ready`. It is a floor under the 8 that are flagged today and says nothing about the other 24, which is a narrower claim than "it asserts nothing" made it sound and a real one. The regression floor it provides is now a floor under the truthful controls and the few rejections, not under the whole set.
