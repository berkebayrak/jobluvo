...
| The table on 18 September after the restamp of that afternoon (D-030), two profiles | 62 ready, 41 held, 4 invalid, of 107, every row carrying the validator revision it passed under. Not a rate: 80 packets on the uploaded profile and 27 on the seeded one, never combined. 6 of the 68 ready moved, 5 of them legacy rows whose summary cannot be revalidated and 1 on the entity rule |
