...
const CIRCLE = "M5 1a4 4 0 1 0 0 8a4 4 0 1 0 0-8";
const X = "M2.5 2.5l5 5M7.5 2.5l-5 5";

export const STATUS: Record<
  Status,
  { label: string; d: string; f: string; tier: Tier }
> = {
  submitted: { label: "Submitted", d: CIRCLE, f: "", tier: "default" },
  needs: {
    label: "Needs you",
    d: CIRCLE,
    f: "M4.4 2.6h1.2v3.2H4.4zM4.4 6.6h1.2v1.2H4.4z",
    tier: "attention",
  },
  ...
  interviewing: {
    label: "Interviewing",
    d: "M3.5 2.5a2.5 2.5 0 1 0 0 5a2.5 2.5 0 1 0 0-5M6.5 2.5a2.5 2.5 0 1 0 0 5a2.5 2.5 0 1 0 0-5",
    f: "",
    tier: "strong",
  },
...
const TIER: Record<
  Tier,
  { border: string; bg: string; color: string; dash: string }
> = {
...
/**
 * The one way to show application state. State is carried by a 10px glyph and
 * a chrome tier, never by colour. Never put two tags on one row.
 */
export function StatusTag({ status = "submitted", size = "md" }: StatusTagProps) {
    ...
    >
      <svg width="10" height="10" viewBox="0 0 10 10">
        <path
          ...
          strokeDasharray={s.tier === "ghost" ? "1.6 1.6" : "0"}
        />
        <path d={s.f} fill="currentColor" />
      </svg>
      {s.label}
    </span>
  );
